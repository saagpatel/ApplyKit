...
- [x] Compare active IDs to `~/Projects/ApplyKit/.cargo/audit.toml` and remove any obsolete ignore entries.
- [x] For each remaining ignore, confirm owner, mitigation issue, and target removal date in `~/Projects/ApplyKit/docs/security-advisory-tracking.md`.
- [x] Re-run strict canonical audit path from repo:
  - `cargo audit -D warnings`
- [x] Update release evidence record with who/when/output paths in `~/Projects/ApplyKit/docs/release-runbook.md`.
...
- Working report:
  - `~/Projects/ApplyKit/docs/week3-security-working-report-2026-03-09.md`
- Closeout:
  - `~/Projects/ApplyKit/docs/week3-closeout-2026-03-13.md`
