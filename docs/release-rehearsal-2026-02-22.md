...
## Commands Executed
1. `bash ~/Projects/ApplyKit/.codex/scripts/run_verify_commands.sh`
2. `bash ~/Projects/ApplyKit/.codex/scripts/run_perf_foundation.sh`
3. `bash ~/Projects/ApplyKit/.codex/scripts/run_perf_enforced.sh`
4. `node ~/Projects/ApplyKit/scripts/ci/require-tests-and-docs.mjs`
...
- Week 5 regression notes:
  - `~/Projects/ApplyKit/docs/week5-regression-notes-2026-03-24.md`
- Week 5 hardening closeout:
  - `~/Projects/ApplyKit/docs/week5-hardening-closeout-2026-03-29.md`
- Week 6 launch log:
  - `~/Projects/ApplyKit/docs/week6-launch-log-2026-04-01.md`
- Week 6 post-launch verification:
  - `~/Projects/ApplyKit/docs/week6-post-launch-verification-2026-04-02.md`
- Week 6 launch report:
  - `~/Projects/ApplyKit/docs/week6-launch-report-2026-04-03.md`
